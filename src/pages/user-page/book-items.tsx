    ...
    return (
        <HoverCard openDelay={200} closeDelay={100}>
            <HoverCardTrigger asChild>
                {/* Thẻ group nằm ở đây giúp group-hover chỉ có tác dụng 
                  khi chuột đi vào đúng phạm vi của cuốn sách này 
                */}
                <div
                    className="cursor-pointer group w-[250px] shrink-0"
                    onClick={onClick}
                >
            ...
            <HoverCardContent
                ...
                align="start"
                sideOffset={15}
                className="w-[480px] bg-[#1e1e20] border-none text-white p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-[100] rounded-xl"
            >
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                        ...
                        <button
                            onClick={(e) => { e.stopPropagation(); setIsLove(!isLove); }}
